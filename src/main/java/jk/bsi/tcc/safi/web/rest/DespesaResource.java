...
public class DespesaResource {
  ...
  public ResponseEntity<DespesaDto> createReceita(@Valid @RequestBody DespesaDto despesaDto) throws
    URISyntaxException {
   ...
   */
  @GetMapping("/despesas")
  public ResponseEntity<List<DespesaDto>> getReceitas(Pageable pageable) {
